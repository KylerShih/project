...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<PhysicalDrive> hd = new ArrayList<PhysicalDrive>();
        ...
        while(!end)
        {
            if(i.indexOf("install-drive ") == 0)
            {
                ...
                if(!exists)
                {
                    ...
                    PhysicalDrive h = new PhysicalDrive(n,s);
                    hd.add(h);
            ...
            else if(i.indexOf("pvcreate ") == 0)
            {
                ...
                else
                {
                    ...
                    for(int n = 0; n < pv.size(); n++)
                    {
                        ...
                        if(pv.get(n).getHardDrive().getName().equals(driveName))
                        {
                    ...
                    if(!error)
                    {
                        PhysicalVolume p = new PhysicalVolume(hd.get(hdNum).getSize(),name, hd.get(hdNum));
                        pv.add(p);
            ...
            else if(i.indexOf("pvlist") == 0)
            {
                ...
                if (error == true) {
                    ...
                    if (!error) {
                        VolumeGroup v = new VolumeGroup(pv.get(pvNum).getSize(),name);
                        vg.add(v);
            ...
            else if(i.indexOf("vgextend") == 0)
            {
                ...
                else
                {
                    ...
                    for(int n = 0; n < pv.size(); n++)
                    {
                        if(pv.get(n).getName().equals(pvName) && pv.get(n).isDrive() == false)
                        {
                            pvNum = n;
                            error = false;
                            break;
            ...
            else if(i.indexOf("vglist") == 0)
            {
                for(int n = 0; n < vg.size(); n++)
                {
                    ...
                    ArrayList<PhysicalVolume> phys = vg.get(n).getPhysicalVolumesArr();
            ...
            else if(i.indexOf("lvlist") == 0)
            {
                for(int n = 0; n < vg.size(); n++)
                {
                    ...
                    {
                        for(int j = 0; j < vg.get(n).getLogicalVolumesArr().size(); j++)
                        {
                            LogicalVolume logV = vg.get(n).getLogicalVolumesArr().get(j);
